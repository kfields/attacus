...
class ExampleCubes : public FlutterCompositeViewVg {
public:
    ExampleCubes(View& parent, ViewParams params = ViewParams()) : FlutterCompositeViewVg(parent, params) {}
    
    virtual void Create() override {
        FlutterCompositeViewVg::Create();
