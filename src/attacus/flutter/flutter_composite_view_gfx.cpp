...
#include "flutter_composite_view_gfx.h"

#include "compositor/gfx/compositor_gfx.h"

namespace attacus
{

FlutterCompositeViewGfx::FlutterCompositeViewGfx(View& parent, ViewParams params) : FlutterView(parent, params)
{
    view_id_ = 0;
    compositor_ = new CompositorGfx(*this);
}

void FlutterCompositeViewGfx::Create() {
    FlutterView::Create();
...
void FlutterCompositeViewGfx::InitProjectArgs(FlutterProjectArgs& args) {
    ...
    {
        FlutterCompositeViewGfx* self = static_cast<FlutterCompositeViewGfx*>(user_data);
        FlutterCompositeViewGfx::PushCallbackEvent(new Delegate([self, baton]() -> void {
            self->OnVSync(baton);
        }), self);
...
void FlutterCompositeViewGfx::OnVSync(intptr_t baton) {
...
void FlutterCompositeViewGfx::PostRender() {
...
void FlutterCompositeViewGfx::Draw() {
    FlutterView::Draw();
